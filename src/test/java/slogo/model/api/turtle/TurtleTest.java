...
//    // fd 100
//    TurtleStep step = myTurtle.move(100).get(0);
...
//    TurtleStep expectedStep =
//        new TurtleStep(expectedInitState, expectedPositionChange, expectedAngelChange);
//    double Xf = 0;
//    double Yf = 100;
...
//    TurtleStep expectedStep1 =
//        new TurtleStep(expectedInitState1, expectedPositionChange1, expectedAngelChange1);
...
//    TurtleStep expectedStep2 =
//        new TurtleStep(expectedInitState2, expectedPositionChange2, expectedAngelChange2);
...
//    Vector expectedPositionChange3 =
//        new Vector(100 * Math.sin(myTurtle.getCurrentState().heading()),
//            100 * Math.cos(myTurtle.getCurrentState().heading()));
//    double expectedAngelChange3 = 0;
//    TurtleStep expectedStep3 =
//        new TurtleStep(expectedInitState3, expectedPositionChange3, expectedAngelChange3);
...
//    Vector expectedPositionChange3 =
//        new Vector(400 * Math.sin(myTurtle.getCurrentState().heading()),
//            400 * Math.cos(myTurtle.getCurrentState().heading()));
//    double expectedAngelChange3 = 0;
//    TurtleStep expectedStep =
//        new TurtleStep(expectedInitState3, expectedPositionChange3, expectedAngelChange3);
//
